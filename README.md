...
Conan is a **Strategist / Controller** built around a deliberately slow clue loop. Clues are stored per enemy (0–6). Every landed basic Deduction gives one Clue; auxiliary Clues from reading an enemy active skill, landing the Wristwatch, or making that enemy miss during one Skateboard ride count toward the same total. **6 total Clues = Case Solved**. Case Solved is spent on **Decisive Evidence / One Truth Prevails**, a low-damage stun with no football involved.

Core values: Deduction 6 damage / 1.6s and +1 Clue on hit; Case Solved at 6 total Clues including auxiliary Clues; Soccer Ball Shot is the **only football attack**, 85 damage / 15s / 3s stun / about 35% arena knockback; Stun-Gun Wristwatch 2 / 12s and +1 auxiliary Clue on hit with immediate 3s Sleep, no damage-based early wake, then 3s Groggy; ChiChi Scolding alone can reflect the tranquilizer needle, and a reflected needle that hits Conan applies the same Sleep → Groggy sequence to him; Turbo Engine Skateboard collision 18 / 10s with one miss-read Clue per enemy/ride; Decisive Evidence 38 damage + 1.5s stun. No low-HP awakening, healing, resurrection, lethal weapon, or hard-coded maximum HP.
